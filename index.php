		...
		<div class="header_agileinfo">
						<div class="w3_agileits_header_text">
								<ul class="top_agile_w3l_info_icons">
									...
									<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:sumaila.ishaq19@leadforghana.org">sumaila.ishaq19@leadforghana.org</a></li>
								</ul>
			...
			<nav class="navbar navbar-default">
				...
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="logo">
						<h3><a class="navbar-brand" href="index.html"> ReDHealth<p>Redefined Digital Health</p></a></h3>
					</div>
				</div>
					...
					<ul id="m_nav_list" class="m_nav menu__list">
						...
						<li class="m_nav_item menu__item" id="moble_nav_item_3 dropdown"> <a href="#" class="menu__link dropdown-toggle" data-toggle="dropdown">User-Login  <b class="caret"></b></a> 
						   <ul class="dropdown-menu agile_short_dropdown">
									<li><a href="dlogin.html">clinician </a></li>
									<li><a href="plogin.html">Patient</a></li>
									<li><a href="plogin.html">Pharmacy</a></li>
			...
			<div class="w3layouts-grids">
					...
					<div class="wthree_team_grid1">
						...
						<div class="css/team.css/wthree_team_grid1_pos">
							<h3 style="color:red;"><center>Mr. Ishaq Sumaila</center></h3>
							<h4 style="color:green; text-align: center;">Physicist</h4>
							<h4 style="color:blue; text-align: center;">FSWD</h4>
						</div>
					</div>
				...
				<div class="col-md-3 wthree_team_grid">
					<div class="wthree_team_grid1">
						<div class="hover14 column">
							<div>
								<figure><img src="images/a5.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="wthree_team_grid1_pos">
							<h3 style="color:red; text-align: center;">Miss Genevene Asaliwena </h3>
							<h4 style="color:green; text-align: center;">General Nurse</h4>
							<h4 style="color:blue; text-align: center;">FSWD</h4>
						</div>
					</div>
					<div class="wthree_team_grid2">
...
<!-- about -->
	<div class="about" id="about">
		<div class="container">
			<h2 class="w3_heade_tittle_agile">Welcome to ReDHealth</h2>
...
<!-- //girds_agileits -->
	...
	<div class="agile_menu" id="menu">
		<div class="container">
		<h3 class="w3_heade_tittle_agile">Our Services</h3>
...
Anesthetics: clinicians in this department give anesthetic for operations and procedures. An anesthetic is a drug or agent that produces a complete or partial loss of feeling. There are three kinds of anesthetic: general, regional and local.
					...
					<ul class="slides">
						...
						<li>
							<div class="w3_agile_services_bottom_right_grid1">
								<p class="w3layouts_head_slide">Hospital <span> Services</span></p>
							</div>
						</li>
						<li>
...
MBBS (Gold Medalist), MS ( Surgery), F.A.I.S, D.N.B (Surgery), M.N.A.M.S, F.I.M.S.A; MRCS (Edin), M.Ch.(Plastic & Reconstructive Surgery)</p>
			...
			<div class="wthree_services_bottom_left_grid">
				<div class="col-md-6 w3_agileits_services_bottom_r_grid">
					...
					<p>Thanks to plastics, medical advances have allowed scientists and clinicians to team up...</p>
			...
			<div class="agile_footer_copy">
				<div class="w3agile_footer_grids">
					<div class="col-md-4 w3agile_footer_grid">
						<h3>About Us</h3>
						<p>ReHealth<span>Redefined Digital Health</span></p>
					</div>
					<div class="col-md-4 w3agile_footer_grid">
						<h3>Contact Info</h3>
						<ul>
							<li><i class="fa fa-map-marker" aria-hidden="true"></i>HOPin Academy,<span>Water Works Road - Tamale.</span></li>
							<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:sumaila.ishaq19@gmail.com">sumaila.ishaq19@gmail.com</a></li>
					...
					<div class="col-md-4 w3agile_footer_grid w3agile_footer_grid1">
						<h3>Navigation</h3>
						<ul>
							<li><span class="fa fa-long-arrow-right" aria-hidden="true"></span><a href="gallery.html">Services</a></li>
