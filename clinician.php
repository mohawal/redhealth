			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					...
					<ul id="m_nav_list" class="m_nav menu__list">
						...
						<li class="m_nav_item menu__item" id="moble_nav_item_5"> <a href="gallery.html" class="menu__link">Services</a> </li>
						<li class="m_nav_item menu__item" id="moble_nav_item_6"> <a href="contact.html" class="menu__link"> Contact </a> </li>
						<li class="m_nav_item menu__item menu__item--current" id="moble_nav_item_3 dropdown"> <a href="#" class="menu__link" data-toggle="dropdown">clinician-Portal</a> 
						   <!-- <ul class="dropdown-menu agile_short_dropdown">
									<li><a href="login.php">clinician </a></li>
...
<div class="tabs tabs-style-bar">
	<nav>
		<ul>
			...
			<li><a href="#appointments" class="icon icon-display"><span>Appointments</span></a></li>
			<li><a href="#section-bar-3" class="icon icon-upload"><span>Department 3</span></a></li>
		</ul>
	</nav>

	<div id="profile" class="agileits w3layouts">
		<div class="container">
				...
				<div class="w3agile_footer_grids">
					...
					<div class="col-md-4 w3agile_footer_grid">
						...
						<ul>
							...
							<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:sumaila.ishaq19@leadforghana.com">sumaila.ishaq19@leadforghana.com</a></li>
					...
					<div class="col-md-4 w3agile_footer_grid w3agile_footer_grid1">
						...
						<ul>
							...
							<li><span class="fa fa-long-arrow-right" aria-hidden="true"></span><a href="gallery.html">Home</a></li>
