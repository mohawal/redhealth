...
if (isset($_POST['signup'])) {
	...
	if (empty($_POST['surname']) || empty($_POST['lastname']) || empty($_POST['email']) || empty($_POST['username']) || empty($_POST['password']) ) {
		echo "Please fill empty fields";
	} else{
		$insert = "INSERT INTO tbl_staff (id, surname, middlename, lastname, email,username, password, phone, designation) VALUES  (:id, :surname, :middlename,:lastname, :email, :username, :password, :phone, :designation)";
		...
		<div class="container">
					...
					<div class="book-appointment">
								...
								<div class="gaps">
									...
									<!-- <div class="gaps">
										<p>Gender</p>	
											<select class="option" placeholder="Gender" name="gender">
												<option></option>
								...
								<div class="right-agileinfo same">
                                    ...
                                    <div class="gaps">
										<p>Designation</p>	
											<select class="option" placeholder="Designation" name="designation">
												<option></option>
								...
								<div style="margin-top: 40px; text-align: center;">
									<input type="submit" value="Already have an account? Log In" onclick="location.href='plogin.php'">
