...
if (isset($_POST['signup'])) {
	...
	if (empty($_POST['surname']) || empty($_POST['lastname']) || empty($_POST['email']) || empty($_POST['password']) ) {
		...
		$insert = "INSERT INTO tbl_pharmacists (id, surname, middlename, lastname, email,username, password, phone) VALUES  (:id, :surname, :middlename,:lastname, :email, :username, :password, :phone)";
	...
	<div class="banner-bottom" id="about">
		<div class="container">
					...
					<div class="book-appointment">
								...
								<div style="margin-top: 40px; text-align: center;">
									<input type="submit" value="Already have an account? Log In" onclick="location.href='pharmacistlogin.php'">
