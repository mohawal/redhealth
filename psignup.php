...
if (isset($_POST['signup'])) {
	...
	if (empty($_POST['surname']) || empty($_POST['lastname']) || empty($_POST['email']) || empty($_POST['password']) ) {
		...
		$insert = "INSERT INTO tbl_patients (id, surname, middlename, lastname, email,username, password, phone) VALUES  (:id, :surname, :middlename,:lastname, :email, :username, :password, :phone)";
