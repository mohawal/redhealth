...
if (isset($_POST['login'])) {
  ...
  $pass = md5($password);
    ...
    $sql = "SELECT * FROM tbl_patients WHERE username = :username AND password = :password LIMIT 1";
		...
		<div class="container">
					...
					<div class="book-appointment">
                                ...
                                <div style="margin-top: 40px; text-align: center;">
									<input type="submit" value="Don’t have an account? Sign Up" onclick="location.href='doctorsignup.php'">
